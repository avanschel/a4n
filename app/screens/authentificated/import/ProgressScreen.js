...
import {endProgress, setLocalParams} from "../../../store/actions/actions";
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={[styles.progress]}>
                    <View style={[styles.progressFill,{width:(isNaN(this.props.progress.percent)?'10 %':this.props.progress.percent+'%')}]} />
                </View>
                <FullButon show ={this.props.progress.button} label='check' title="Ok!" press={()=>this.closeScreen()} style={styles.btnClose} />
            </View>
        )
    };
}
